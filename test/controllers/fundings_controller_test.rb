...
class FundingsControllerTest < ActionController::TestCase
  ...
  test "should create funding" do
    assert_difference('Funding.count') do
      post :create, funding: { amtCurrent: @funding.amtCurrent, amtTarget: @funding.amtTarget, content: @funding.content, photo: @funding.photo, title: @funding.title }
    end
  ...
  test "should update funding" do
    patch :update, id: @funding, funding: { amtCurrent: @funding.amtCurrent, amtTarget: @funding.amtTarget, content: @funding.content, photo: @funding.photo, title: @funding.title }
    assert_redirected_to funding_path(assigns(:funding))
  end
